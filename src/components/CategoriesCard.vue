...
<template>
  <div class="w-full px-1 my-1 md:w-1/2 lg:my-4 lg:px-4 lg:w-1/4">
    <div class="overflow-hidden border border-gray-200 rounded-xl">
      <RouterLink :to="{ name:'category-item', params: {id:id} }">
      ...
      <header class="px-4 mb-4 leading-tight">
        <h1 class="text-lg">
          <RouterLink class="font-semibold text-black no-underline hover:underline" :to="{ name:'category-item', params: {id:id} }">
            {{ title }}
          </RouterLink>
        </h1>
